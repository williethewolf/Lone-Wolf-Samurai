...
@export var single_player_zoom : float = 1  # Adjust this value to set the zoom level for single player
...
@export var vertical_offset : float = 75  # Adjust this value based on the character height
